...
class PostController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        $post->tags()->sync($request->tags, false); //If true will delete all other associations. We just want to add.
    ...
    public function edit($id)
    {
        ...
        // Categories. Formatting into special format - associative array.
        $categories = Category::all();
        $cats = [];
        ...
        // Tags. Formatting into special format - associative array.
    ...
    {
        $post = Post::find($id);
        $post->tags()->detach(); // Removes tag references when deleting post.
